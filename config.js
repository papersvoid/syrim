module.exports = {
  OWNER_IDS: [679038012264284205], // Bot owner ID's
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "980935732480868383", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
